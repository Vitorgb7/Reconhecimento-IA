...
async function classificarImagem(img) {
    ...
    for(let i = 0; i < maxPredictions; i++){
        ...
        // essa linha ajuda a determinar a classe com a maior probabilidade de correspondência para a imagem carregada
    ...
    if(maxClass === "Vingadores"){
        ...
        imgClasse.src = "Assets/marvel-intro.gif";
        imgClasse.style.width = '300px'
        ...
        const imgClasse = document.getElementById('img-classe');
        imgClasse.src = "Assets/dc-comics-dc-universe.gif";
